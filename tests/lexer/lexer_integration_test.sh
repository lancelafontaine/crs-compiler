...
EXPECTED_OUTPUT="Token { class: '< accessor_operator, . >', lexeme: '.' }"
run_test
...
EXPECTED_OUTPUT="Token { class: '< open_square_bracket >', lexeme: '\[' }"
run_test

SOURCE_FILE="${SCRIPTPATH}/source_files/close_square_bracket.txt"
EXPECTED_OUTPUT="Token { class: '< close_square_bracket >', lexeme: '\]' }"
run_test

SOURCE_FILE="${SCRIPTPATH}/source_files/inheritance_operator_valid.txt"
EXPECTED_OUTPUT="Token { class: '< inheritance_operator >', lexeme: ':' }"
run_test
...
EXPECTED_OUTPUT="Token { class: '< scope_resolution_operator >', lexeme: '::' }"
run_test
